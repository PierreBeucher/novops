...
- [Shell](examples/shell.md)
- [Docker & Podman](examples/docker.md)
- [Nix](examples/nix.md)
- CI / CD
...
See [Hashicorp Vault doc](./config/hashicorp-vault.md)
...
See [Variables and Files doc](config/files-variables.md)
...
- See [Novops configuration details and modules](config/README.md)
- [Novops Security Model](security.md)
- Checkout [Advanced examples and Use Cases](./examples/README.md)