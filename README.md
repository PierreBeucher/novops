...
- [Modules: load and generate temporary secrets](#modules-load-and-generate-temporary-secrets)
  - [Hashicorp Vault](#hashicorp-vault)
  - [AWS](#aws)
  - [See all modules: AWS, Hashicorp Vault, GCloud, Azure...](#see-all-modules-aws-hashicorp-vault-gcloud-azure)
...
Novops can also write files such as SSH keys. Files are not written to disk but in memory in a secure directory, see [Novops Security Model](https://pierrebeucher.github.io/novops/security.html).
...
## Modules: load and generate temporary secrets

Novops load and generate temporary secrets from various platforms and providers via _modules_. Configure them in `.novops.yml`:
